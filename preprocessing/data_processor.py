# Disable specific warnings for this block
...
class DataPreprocessor:
    ...
    def handle_missing_values(self):
        ...
        # Fill missing 'Age' values based on median age grouped by Sex
        # and Pclass then full median
        self.train["Age"] = self.train.groupby(["Sex", "Pclass"])["Age"].transform(
